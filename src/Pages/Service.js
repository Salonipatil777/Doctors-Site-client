              ...
              <div className="col-lg-4 col-md-6 mb-30">
                <div className="feature-container feature-bx2 feature1">
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      medical specialized. identifying a particular illness
              ...
              <div className="col-lg-4 col-md-6 mb-30">
                <div className="feature-container feature-bx2 feature2">
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      the act or manner or an instance of treating someone or
                      something towards another.
                    </p>
                    <Link
                      to="/serviceDetails"
                      className="btn btn-primary light"
              ...
              <div className="col-lg-4 col-md-6 mb-30">
                <div className="feature-container feature-bx2 feature1">
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      Consultants are senior doctors that have completed full
                      medical training in a specialised area of medicine.
                    </p>
                    <Link
                      to="/serviceDetails"
                      className="btn btn-primary light"
